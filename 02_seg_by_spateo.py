#02_drosophila_pipe_v1_after_PS
...
#aout
name_list = ['cropped_img','bin1_data','seg_01','seg_02','bin20']
for aaa in name_list:
    out = os.path.join(aout,aaa)
    if not os.path.exists(out):
        os.makedirs(out)

out_01 = os.path.join(aout,'seg_01')
...
#qc_txt_save_01 = os.path.join(out_01,'qc','all_slices_qc.txt')
...
'''
            ...
            bin1_data = bin1_data.rename(columns={'MIDCount':'MIDCounts'})
            ...
            print('===== seg by yjj :',project,' cellbin finished! =====')
...
print('===== num of slices:',num,'finished:4 (1)=====')
